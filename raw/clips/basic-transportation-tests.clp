...
(defrule init-btt
  ...
  ?bm <- (object (is-a Test))
  =>
  (make-instance [BTT1] of BasicTransportationTest1 (type BTT) (type-id 1) (description "Prepare Assembly Aid Tray"))
  (make-instance [BTT3] of BasicTransportationTest3 (type BTT) (type-id 3) (description "Fill a Box with Parts for Manual Assembly"))
