;---------------------------------------------------------------------------
;  device-conveyor-belt.clp - RoboCup-at-Work RefBox CLIPS - Conveyor belt interface
;
;  Licensed under BSD license, cf. LICENSE file
;---------------------------------------------------------------------------

(defrule net-recv-ConveyorBeltCommand-client
  ?mf <- (protobuf-msg (type "raw_msgs.ConveyorBeltCommand") (ptr ?p)
...
(deffunction net-create-ConveyorBeltStatus ()
  ...
  (bind ?pb-status (pb-create "raw_msgs.ConveyorBeltStatus"))
...
(defrule net-recv-TriggeredConveyorBeltCommand
  ?mf <- (protobuf-msg (type "raw_msgs.TriggeredConveyorBeltCommand") (ptr ?p)
         (rcvd-via ?via) (rcvd-from ?host ?port))
...
(deffunction net-create-TriggeredConveyorBeltStatus (?current-cycle)
  ; Instantiate a new status message
  (bind ?pb-status (pb-create "raw_msgs.TriggeredConveyorBeltStatus"))
