;---------------------------------------------------------------------------
;  device-force-fitting-machine.clp - RoboCup-at-Work RefBox CLIPS - Force fitting
;                                     machine interface
;
...
(defrule net-recv-ForceFittingMachineCommand
  ?mf <- (protobuf-msg (type "raw_msgs.ForceFittingMachineCommand") (ptr ?p)
...
(deffunction net-create-ForceFittingMachineStatus ()
  ...
  (bind ?pb-status (pb-create "raw_msgs.ForceFittingMachineStatus"))
