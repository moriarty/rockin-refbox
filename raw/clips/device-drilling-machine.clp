;---------------------------------------------------------------------------
;  device-drilling-machine.clp - RoboCup-at-Work RefBox CLIPS - Drilling machine interface
;
...
(defrule net-recv-DrillingMachineCommand
  ?mf <- (protobuf-msg (type "raw_msgs.DrillingMachineCommand") (ptr ?p)
...
(deffunction net-create-DrillingMachineStatus ()
  ...
  (bind ?pb-status (pb-create "raw_msgs.DrillingMachineStatus"))
